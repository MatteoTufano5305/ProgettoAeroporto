...
import org.example.model.UtenteGenerico; // Importante!
...
public class RicercaVolo extends JFrame {
    ...
    public static void main(String[] args) {
        ...
        UtenteGenerico userTest = new UtenteGenerico(1, "test", "pass", "Mario Rossi");
        SwingUtilities.invokeLater(() -> new RicercaVolo(userTest));
    }
}